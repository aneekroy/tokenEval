...
TOKENIZER_REGISTRY: dict[str, dict] = {
    "byt5": {
        ...
        "expected_vocab": 384,      # ByT5 reserves some special IDs; effective is 256 bytes
        "effective_vocab": 256,
        "family": "byte",
    ...
    "qwen25": {
        ...
        "effective_vocab": 151_643,  # some slots are special tokens
        "family": "bpe-byte",
